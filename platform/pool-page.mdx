...
View and claim snapshot-based USDT yields. Click **Withdraw USDT Rewards** to claim without unstaking.
...
| **Total USDT Yields** | USDT distributed to stakers based on shop revenue |
